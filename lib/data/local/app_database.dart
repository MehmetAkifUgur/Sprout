...
class AppDatabase {
  ...
  /// v2: habits.reminder_minutes (Hafta 3)
  /// v3: app_settings (Hafta 4)
  ...
  static Future<void> _migrateToV2(Database db) =>
      db.execute('ALTER TABLE habits ADD COLUMN reminder_minutes INTEGER');

  static Future<void> _migrateToV3(Database db) => db.execute('''
